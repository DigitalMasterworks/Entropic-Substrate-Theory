...
MODE = "pdg"   # <-- set "pdg" to fix the 0.00##% curve; "sim" reproduces your previous anchor-slope
...
if MODE == "pdg":
    ...
    ln_g = math.log(LAM_MU_STAR / LAM_E_STAR) / STEPS_EM  # slope implied by your sim anchors
g = math.exp(ln_g)
