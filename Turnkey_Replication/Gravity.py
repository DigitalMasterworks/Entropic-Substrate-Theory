...
with open(log_filename, 'w') as log_file:
    ...
    log_print("Case 1: S = 1 + Phi/c^2")
    log_print("g_tt expansion:", sp.series(g_tt1, Phi, 0, 3))
    log_print("g_rr expansion:", g_rr1)
    ...
    gamma1 = 1
    log_print("=> PPN beta =", beta1, ", gamma =", gamma1)
    log_print()
    ...
    log_print("Case 2: S = exp(Phi/c^2)")
    log_print("g_tt expansion:", sp.series(g_tt2, Phi, 0, 3))
    log_print("g_rr expansion:", g_rr2)
    ...
    beta2 = 1
    gamma2 = 1
    log_print("=> PPN beta =", beta2, ", gamma =", gamma2)