#!/usr/bin/env python3
# bsd_to_lean_print.py
# Terminal-only: paste your ap_map into this script (or modify to compute it)
from typing import Dict, List, Tuple
import sys

# Replace this dict with the ap table you computed (you can paste in your map)
ap_map = {
...
print("  -- Replace True/placeholder above with your formal analytic lemmas and the explicit local_factor_match predicate.")
print("  by trivial")
print("\nend BSDReverse")
print("end Myproject")