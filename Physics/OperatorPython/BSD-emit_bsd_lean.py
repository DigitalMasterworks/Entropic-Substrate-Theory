#!/usr/bin/env python3
# tools/emit_bsd_lean.py
# Usage: python3 tools/emit_bsd_lean.py path/to/ap_table.csv > Myproject/BSDBridge_data.lean
...
def read_table(path):
    ...
    try:
        ...
        for r in reader:
            if not r: continue
            # find first two numeric-like tokens
        ...
        pass
    # fallback: look for "p a_p" or "p, a_p" anywhere
    for line in buf:
...
if __name__ == "__main__":
    ...
    print("import Mathlib.Data.Rat")  # adjust if you need mathlib import
    print("")
    print("-- This file was generated by tools/emit_bsd_lean.py")
    print(f"-- source: {sys.argv[1]}")
    print("")
    for p, ap in rows:
        # Lean theorem name: a_p_2, a_p_3, ...
        thm_name = f"a_p_{p}"
        # print integer as Lean int literal
